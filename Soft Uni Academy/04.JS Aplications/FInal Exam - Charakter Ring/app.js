...
// Define your components or views using lit-html
const homeView = html`
  <section id="hero">
...
const charactersView = (characters) => html`
  <h2>Characters</h2>
  <section id="characters">
  ...
  ${characters.length === 0 ? html`<h2>No added Heroes yet.</h2>` : ''}
`;

// Define your routes using page.js
page('/', () => render(homeView, document.getElementById('main')));
page('/characters', () => {
  const characters = getCharacters;
  render(charactersView(characters), document.getElementById('main'));
});
page('/', () => render(homeView, document.getElementById('main')));
page('/characters', () => {
  const charactersAdd = createCharacter;
  render(charactersView(charactersAdd), document.getElementById('main'));
});
